...
public class HardCodedExamples {
    ...
    String token = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE2MjY2MzE5MjQsImlzcyI6ImxvY2FsaG9zdCIsImV4cCI6MTYyNjY3NTEyNCwidXNlcklkIjoiMzAwNCJ9.vkP28g1UnYFQowFQmt7iNkcK4YGeD0NxNowZ06n47_8";
    ...
    public void sampleTest() {
        ...
        RequestSpecification preparedRequest = given().header("Authorization", token)
                .header("Content-Type", "application/json").queryParam("employee_id", "17720");
